...
let _toastedGiveUps = new Set();   // pids we've already shown a give-up banner for
let _flashedConclusionEndedAt = null; // endedAt of the last round we flashed the tab title for
...
let _statsWitnessedActive = false; // saw the current round while active — gates career recording
